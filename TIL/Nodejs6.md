...
<head>
  ...
  <script src="./js/clinet.js"></script>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <%
        if(flag==0){
      %>
      <div><input  value="bbc@hanmail.net" id="login_email">
        <input id="login_btn" class="btn btn-success" type="button" value="login"> </div>
      <%
        }else{
      %>
      <%= name %>
      <input id="logout_btn" class="btn btn-danger" type="button" value="logout"> </div>
      <%
        }
      %>
      </div>
